...
def txt_to_csv(new_txt_file_path, csv_file_path):
    ...
    wear_conditions = ['FN', 'MW', 'FT', 'WW', 'BS']
...
old_txt_file_path = 'IDS/Halo/all_haloids.txt'
new_txt_file_path = 'IDS/Halo/haloids.txt'
csv_file_path = 'IDS/Halo/halo_ids.csv'
